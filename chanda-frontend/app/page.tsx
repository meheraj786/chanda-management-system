    ...
    <main className="min-h-screen bg-background">
      ...
      <header className="border-b sticky top-0 bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="text-2xl font-bold">👹 Chanda Hell</div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <section className="text-center py-8">
          <h1 className="text-4xl font-bold mb-4">Welcome to Chanda Hell</h1>
          <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
            Where donations are tracked, guilt is weaponized, and shame is a sport.
            Join thousands of people escaping (or failing to escape) the burden of chanda.
          </p>
          <Link href="/donate">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium">Districts Suffering</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <section className="bg-muted py-12 rounded-lg text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
            Stop fighting your conscience. Give in. Donate. Let the guilt consume you.
          </p>
          <Link href="/donate">
            <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white">
              Start Donating
