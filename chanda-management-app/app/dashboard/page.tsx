      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mt-8 bg-muted">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mb-4">
              Your donation record is proof of your commitment to the guilt
              culture. The more you donate, the more respected you'll be in the
              leaderboard. Or maybe not. Who knows?
            </p>
